...
PostcodeGeocoder <- R6Class("PostcodeGeocoder",
                            public = list(
                              ...
                              initialize = function(nspl_csv = NA, add_nspl_cols = NULL){
                              ...
                              extract_pcds = function(column, pcd_data = NA){
                                ...
                                #' Defaults to NA, which brings up a file selection dialog box. 
                              ...
                              geocode_pcds = function(column, pcd_data = NA){
                            ...
                            private = list(
                              ...
                              read_nspl = function(nspl_csv = NA){
                                ...
                                #' @param nspl_csv character. The file path of the National Statistics Postcode Lookup CSV file.
                                #' Defaults to NA, where it searches the cwd for the first filename starting with "NSPL_" 
